...
/**
 * {@link Ex09_NoOffsetItemReader}를 생성하는 빌더 클래스입니다.
 * No-Offset 기반의 페이징 처리를 위한 ItemReader를 손쉽게 설정하고 생성할 수 있도록 돕습니다.
 *
 * @param <T> 읽어올 아이템의 타입
 */
public class Ex09_NoOffsetItemReaderBuilder<T> {
     ...
     * @return 빌더 인스턴스
     */
    public Ex09_NoOffsetItemReaderBuilder<T> name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return 빌더 인스턴스
     */
    public Ex09_NoOffsetItemReaderBuilder<T> entityManagerFactory(EntityManagerFactory entityManagerFactory) {
     ...
     * @return 빌더 인스턴스
     */
    public Ex09_NoOffsetItemReaderBuilder<T> chunkSize(int chunkSize) {
     ...
     * @return 빌더 인스턴스
     */
    public Ex09_NoOffsetItemReaderBuilder<T> queryString(String queryString) {
     ...
     * @return 빌더 인스턴스
     */
    public Ex09_NoOffsetItemReaderBuilder<T> parameterValues(Map<String, Object> parameterValues) {
     ...
     * @return 빌더 인스턴스
     */
    public Ex09_NoOffsetItemReaderBuilder<T> idExtractor(Function<T, Long> idExtractor) {
     ...
     * @return 빌더 인스턴스
     */
    public Ex09_NoOffsetItemReaderBuilder<T> targetType(Class<T> targetType) {
        this.targetType = targetType;
        return this;
    }

    /**
     * 설정된 값들을 기반으로 {@link Ex09_NoOffsetItemReader} 인스턴스를 생성합니다.
     * 필수 값이 설정되었는지 검증합니다.
     *
     * @return NoOffsetItemReader 인스턴스
     */
    public Ex09_NoOffsetItemReader<T> build() {
        ...
        return new Ex09_NoOffsetItemReader<>(
